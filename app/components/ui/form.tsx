...
import { Controller, type ControllerProps, type FieldError, type FieldPath, type FieldValues, FormProvider, useFormContext } from 'react-hook-form'
...
const FormField = <TFieldValues extends FieldValues = FieldValues, TName extends FieldPath<TFieldValues> = FieldPath<TFieldValues>>({
  ...
  const contextValue = React.useMemo<FormFieldContextValue<TFieldValues, TName>>(() => ({ name: props.name }), [props.name])
  return (
