...
export function GoogleAuthButton({ mode, disabled = false, className = '' }: GoogleAuthButtonProps): JSX.Element {
  ...
  return (
    <Button type="button" variant="outline" className={`w-full ${className}`} onClick={handleGoogleAuth} disabled={disabled || isLoading}>
      {isLoading ? (
        <>
