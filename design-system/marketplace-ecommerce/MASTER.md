...
> **LOGIC:** When building a specific page, first check `design-system/pages/[page-name].md`. If that file exists, its rules **override** this Master file. If
> not, strictly follow the rules below.

---

**Project:** Marketplace Ecommerce **Generated:** 2026-05-11 00:15:58 **Category:** Micro SaaS
